...
# Survival images mapping (assumes image files exist in a local folder)
image_mapping = {
    "Fire Making": "images/fire_making.png",
    "Water Purification": "images/water_purification.png",
    "Shelter Building": "images/shelter_building.png",
    "Navigation": "images/navigation.png",
    "First Aid": "images/first_aid.png",
}

def display_menu():
    print("\n🔹 Offline AI Survival Guide with Images 🔹")
...
def search_survival_guide(topic):
    ...
    for key, value in survival_guide_data.items():
        if topic_lower in key.lower():
            response = f"**{key}**\n{value}"
            image_path = image_mapping.get(key, "No image available.")
